...
[![My Skills](https://skillicons.dev/icons?i=react,js,html,css,sass,nodejs,express,flutter,laravel,ts,python,php,dart,sqlite,mysql,postgresql,mongodb,docker,redux,firebase,netlify,heroku,androidstudio,git,github,gitlab,vscode)](https://skillicons.dev)
